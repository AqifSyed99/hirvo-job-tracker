      ...
      <form @submit.prevent="handleSubmit" novalidate>
        <div class="form-group">
          ...
          <input
            ...
            type="text"
            class="form-input"
            :class="{ 'form-input--error': fieldErrors.full_name }"
        ...
        <div class="form-group">
          ...
          <div class="password-wrapper">
            <input
              ...
              :disabled="loading"
            />
            <button type="button" class="password-toggle" @click="showPassword = !showPassword" :aria-label="showPassword ? 'Hide' : 'Show'">
        ...
        <div class="form-group">
          ...
          <div class="password-wrapper">
            <input
              ...
              :disabled="loading"
            />
            <button type="button" class="password-toggle" @click="showConfirm = !showConfirm" :aria-label="showConfirm ? 'Hide' : 'Show'">
...
function validate() {
  ...
  if (confirmPassword.value !== password.value) errors.confirmPassword = 'Passwords do not match.'
  return errors
}
